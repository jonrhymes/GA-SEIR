...
// !!! Problem: I'm struggling with the game functionality. How does the input affect the outcome and continue running the game? I've set up the multiple aliens
...
while(ussNOVA.hull > 0 && alienShip > 0) { // Know if there are more alien ships to fight
    if(novaTurn === true){ // Comparison
    ussNOVA.attack(alienShip);
    novaTurn = false; // Re-assigning
    }else{
    alienShip.attack(ussNOVA);
    novaTurn = true;
    }
    // novaTurn = !novaTurn; // This is the SWITCH
};
